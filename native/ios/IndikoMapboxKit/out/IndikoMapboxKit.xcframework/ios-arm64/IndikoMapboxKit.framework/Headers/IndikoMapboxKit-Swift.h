...
#ifndef INDIKOMAPBOXKIT_SWIFT_H
#define INDIKOMAPBOXKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="IndikoMapboxKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("IKCameraState")
@interface IKCameraState : NSObject
...
SWIFT_PROTOCOL_NAMED("IKMapEventListener")
@protocol IKMapEventListener
- (void)onMapReady;
- (void)onStyleLoaded;
...
SWIFT_CLASS_NAMED("IKMapView")
@interface IKMapView : UIView
@property (nonatomic, weak) id <IKMapEventListener> _Nullable listener;
- (nonnull instancetype)initWithFrame:(CGRect)frame styleUri:(NSString * _Nonnull)styleUri latitude:(double)latitude longitude:(double)longitude zoom:(double)zoom bearing:(double)bearing pitch:(double)pitch OBJC_DESIGNATED_INITIALIZER;
